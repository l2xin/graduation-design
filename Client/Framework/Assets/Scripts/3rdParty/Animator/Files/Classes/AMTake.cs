...
public class AMTake : ScriptableObject
{
    ...
    public delegate void OnTakeBegin();
    public delegate void OnTakeUpdate();
    public delegate void OnTakeEnd();

    public event OnTakeBegin BeginListener;
    public event OnTakeUpdate UpdateListener;
    public event OnTakeEnd EndListener;
    #endregion
    ...
    {
        if (BeginListener != null) BeginListener();
    }
