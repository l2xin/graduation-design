/*----------------------------------------------------------------
            ...
            // 版权所有。 
            //`
            // 文件名： CustomTypewriterEffect.cs
            // 文件功能描述：自定义打字机, 修改文字后自动刷新;
            // 
            // 创建标识：陈伟超_20150917
...
namespace QiuMo
{
	...
	public class CustomTypewritterEffect : MonoBehaviour
	{
		static public CustomTypewritterEffect current;
		...
		public UIEventListener.VoidDelegate onFinished;
